...
async def lifespan(_app: FastAPI) -> AsyncGenerator[None, None]:
    try:
        from app.infrastructure.mongodb import ensure_knowledge_upload_indexes, ensure_ticket_idempotency_index
        ...
        if db is not None:
            ...
            await ensure_ticket_idempotency_index(db)
    except Exception:
        logger.warning("Could not reconcile indexes at startup", exc_info=True)
