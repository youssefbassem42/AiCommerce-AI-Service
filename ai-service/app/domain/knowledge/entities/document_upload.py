...
class DocumentUpload(Entity[str]):
    ...
    organization_id: str | None = Field(default=None, description="Organization scope (optional claim)")
    store_id: str | None = Field(default=None, description="Store scope (optional claim)")
