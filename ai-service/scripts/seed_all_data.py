...
ELECTRONICS = {
    ...
    "categories": [
        ...
        {"external_id": "cat_elec_003", "name": "Accessories", "description": "Peripherals & accessories", "handle": "accessories"},
        {"external_id": "cat_elec_004", "name": "Audio", "description": "Headphones & audio", "handle": "audio"},
    ],
    "customers": [
        {"external_id": "cust_elec_001", "email": "alice@example.com", "first_name": "Alice", "last_name": "Johnson", "phone": "+1-555-0101", "accepts_marketing": True},
        {"external_id": "cust_elec_002", "email": "bob@example.com", "first_name": "Bob", "last_name": "Smith", "phone": "+1-555-0102", "accepts_marketing": False},
    ],
    "tickets": [
        {
...
FASHION = {
    ...
    "categories": [
        ...
        {"external_id": "cat_fash_005", "name": "Accessories", "description": "Scarves, belts & sunglasses", "handle": "accessories"},
    ],
    "customers": [
        {"external_id": "cust_fash_001", "email": "carol@example.com", "first_name": "Carol", "last_name": "Davis", "phone": "+1-555-0201", "accepts_marketing": True},
        {"external_id": "cust_fash_002", "email": "dave@example.com", "first_name": "Dave", "last_name": "Wilson", "phone": "+1-555-0202", "accepts_marketing": True},
    ],
    "tickets": [
        {
...
async def seed_all():
    ...
    for store_id, cfg in TENANTS.items():
        ...
        order_docs = [
            build_doc(store_id, org_id, {
                ...
                "total_tax": {"amount": round(prod[0]["variants"][0]["price"]["amount"] * 0.08, 2), "currency": currency},
        ...
        for p in prod:
            for v in p["variants"]:
                inv_docs.append(build_doc(store_id, org_id, {
        ...
        for t in data["tickets"]:
            ticket_docs.append(build_doc(store_id, org_id, {
    ...
    FAQ_ENTRIES = [
        {"external_id": "faq_001", "question": "What is your return policy?", "answer": "We accept returns within 30 days of purchase."},
        {"external_id": "faq_002", "question": "How long does shipping take?", "answer": "Standard shipping 3-5 business days; Express 1-2 business days."},
        {"external_id": "faq_003", "question": "What payment methods do you accept?", "answer": "Visa, Mastercard, Amex, PayPal, and Apple Pay."},
    ]
    POLICY_ENTRIES = [
        {"external_id": "policy_001", "title": "Refund Policy", "content": "Full refunds within 30 days in original condition."},
        {"external_id": "policy_002", "title": "Privacy Policy", "content": "We do not share customer data with third parties except shipping carriers."},
    ]
    ...
    for store_id, cfg in TENANTS.items():
        ...
        for faq in FAQ_ENTRIES:
            entity_docs.append({
                ...
                "entity_type": "faq", "external_id": faq["external_id"],
        ...
        for pol in POLICY_ENTRIES:
            entity_docs.append({
                "store_id": store_id, "organization_id": org_id,
                "entity_type": "policy", "external_id": pol["external_id"],
