...
ELECTRONICS_PRODUCTS = [
    {
        "external_id": "prod_elec_001", "title": "MacBook Pro 16-inch M3 Max",
        "description": "Apple MacBook Pro with M3 Max chip, 36GB RAM, 1TB SSD, 16-inch Liquid Retina XDR display",
        "price": 3499.99, "sku": "MBP-M3-16-36-1TB", "category": "Laptops", "brand": "Apple",
    ...
    {
        "external_id": "prod_elec_002", "title": "Dell XPS 15 OLED",
        "description": "Dell XPS 15 with Intel Core i9-13900H, 32GB RAM, 1TB SSD, 15.6-inch OLED display",
        "price": 2499.99, "sku": "DEL-XPS-15-i9-32-1TB", "category": "Laptops", "brand": "Dell",
    ...
    {
        "external_id": "prod_elec_003", "title": "LG 27-inch 4K Monitor",
        "description": "LG 27UP850N 27-inch 4K UHD IPS Monitor with USB-C 96W PD, HDMI, DisplayPort",
        "price": 499.99, "sku": "LG-27UP850N", "category": "Monitors", "brand": "LG",
    ...
    {
        "external_id": "prod_elec_005", "title": "Logitech MX Mechanical Keyboard",
        "description": "Logitech MX Mechanical Wireless Keyboard with Tactile Switches, Full-size, Bluetooth + USB-C",
        "price": 149.99, "sku": "LOG-MX-MECH", "category": "Accessories", "brand": "Logitech",
    ...
    {
        "external_id": "prod_elec_006", "title": "Logitech MX Master 3S Mouse",
        "description": "Logitech MX Master 3S Wireless Performance Mouse with 8K DPI, Quiet Clicks, USB-C",
        "price": 99.99, "sku": "LOG-MX-MASTER-3S", "category": "Accessories", "brand": "Logitech",
    ...
    {
        "external_id": "prod_elec_007", "title": "Sony WH-1000XM5 Headphones",
        "description": "Sony WH-1000XM5 Wireless Noise Cancelling Headphones, 30h battery, Adaptive ANC",
        "price": 349.99, "sku": "SONY-WH1000XM5", "category": "Audio", "brand": "Sony",
    ...
    {
        "external_id": "prod_elec_008", "title": "Apple AirPods Pro 2nd Gen",
        "description": "Apple AirPods Pro 2nd Generation with USB-C, Adaptive Audio, H2 Chip",
        "price": 249.99, "sku": "AP-AIRPODS-PRO-2", "category": "Audio", "brand": "Apple",
    ...
    {
        "external_id": "prod_elec_009", "title": "Phone Stand Adjustable",
        "description": "Adjustable aluminum phone stand for cooking/desk use, 360° rotation, fits all phones up to 7 inch",
        "price": 24.99, "sku": "PH-STAND-001", "category": "Accessories", "brand": "DesiCo",
        "inventory_quantity": 200,
        "specs": {"material": "Aluminum", "rotation": "360°", "compatibility": "4-7 inch phones", "use_case": "Desk, Kitchen, Bedside"},
        "max_discount_pct": 25.0,
        "image_url": "https://store.example.com/phone-stand.jpg",
    },
    {
        "external_id": "prod_elec_010", "title": "ASUS RTX 4080 Graphics Card",
        "description": "ASUS ROG Strix GeForce RTX 4080 16GB GDDR6X Graphics Card, PCIe 4.0",
        "price": 1199.99, "sku": "ASUS-RTX4080-16G", "category": "Components", "brand": "ASUS",
...
ELECTRONICS_CATEGORIES = [
    ...
    {"external_id": "cat_elec_002", "name": "Monitors", "description": "Computer monitors and displays, including monitor arms and stands"},
    {"external_id": "cat_elec_003", "name": "Accessories", "description": "Computer peripherals, keyboards, mice, phone stands, and accessories"},
...
FASHION_PRODUCTS = [
    {
        "external_id": "prod_fash_001", "title": "Classic Leather Jacket",
        "description": "Premium genuine leather jacket, slim fit, with quilted lining and YKK zippers",
        "price": 299.99, "sku": "FASH-LJ-001", "category": "Outerwear", "brand": "UrbanEdge",
    ...
    {
        "external_id": "prod_fash_002", "title": "Designer Denim Jeans",
        "description": "Slim-fit designer denim jeans, stretch cotton blend, 5-pocket styling",
        "price": 89.99, "sku": "FASH-DJ-001", "category": "Bottoms", "brand": "UrbanEdge",
    ...
    {
        "external_id": "prod_fash_003", "title": "Merino Wool Sweater",
        "description": "Lightweight merino wool crew neck sweater, machine washable, perfect for layering",
        "price": 129.99, "sku": "FASH-MW-001", "category": "Tops", "brand": "CozyLuxe",
    ...
    {
        "external_id": "prod_fash_004", "title": "Cashmere Scarf",
        "description": "Luxurious pure cashmere scarf, 180cm x 70cm, fringed edges, available in 12 colors",
        "price": 79.99, "sku": "FASH-CS-001", "category": "Accessories", "brand": "CozyLuxe",
    ...
    {
        "external_id": "prod_fash_005", "title": "Leather Crossbody Bag",
        "description": "Handcrafted genuine leather crossbody bag with adjustable strap, multiple compartments",
        "price": 159.99, "sku": "FASH-CB-001", "category": "Bags", "brand": "UrbanEdge",
        "inventory_quantity": 35,
        "specs": {"material": "Genuine Leather", "strap": "Adjustable 120cm", "compartments": "3 Internal + 1 Zip", "closure": "Magnetic Snap"},
        "max_discount_pct": 12.0,
        "image_url": "https://store.example.com/crossbody-bag.jpg",
    },
    {
        "external_id": "prod_fash_006", "title": "Silk Evening Dress",
        "description": "Elegant silk evening dress, floor-length, with V-neckline and concealed side zip",
        "price": 249.99, "sku": "FASH-SD-001", "category": "Dresses", "brand": "EleganceStudio",
        "inventory_quantity": 15,
        "specs": {"material": "100% Silk", "length": "Floor-length", "neckline": "V-Neck", "closure": "Concealed Side Zip"},
        "max_discount_pct": 10.0,
        "image_url": "https://store.example.com/silk-dress.jpg",
    },
    {
        "external_id": "prod_fash_007", "title": "Running Sneakers",
        "description": "Lightweight running sneakers with responsive cushioning, breathable mesh upper",
        "price": 119.99, "sku": "FASH-RS-001", "category": "Footwear", "brand": "StepFit",
        "inventory_quantity": 60,
    ...
    {
        "external_id": "prod_fash_008", "title": "Leather Ankle Boots",
        "description": "Classic leather ankle boots with side zip, block heel, cushioned insole",
        "price": 179.99, "sku": "FASH-LB-001", "category": "Footwear", "brand": "UrbanEdge",
        "inventory_quantity": 40,
        "specs": {"material": "Genuine Leather", "heel": "Block 4cm", "closure": "Side Zipper", "sole": "Leather + Rubber"},
        "max_discount_pct": 15.0,
        "image_url": "https://store.example.com/ankle-boots.jpg",
    },
    {
        "external_id": "prod_fash_009", "title": "Leather Belt",
        "description": "Italian leather belt with brushed buckle, 3.5cm width, reversible design",
        "price": 59.99, "sku": "FASH-LBT-001", "category": "Accessories", "brand": "UrbanEdge",
        "inventory_quantity": 120,
        "specs": {"material": "Italian Leather", "width": "3.5cm", "buckle": "Brushed Metal", "design": "Reversible Black/Brown"},
        "max_discount_pct": 10.0,
        "image_url": "https://store.example.com/leather-belt.jpg",
    },
    {
        "external_id": "prod_fash_010", "title": "Aviator Sunglasses",
        "description": "Classic aviator sunglasses with polarized lenses, gold frame, UV400 protection",
        "price": 149.99, "sku": "FASH-AS-001", "category": "Accessories", "brand": "EleganceStudio",
...
FASHION_CATEGORIES = [
    ...
    {"external_id": "cat_fash_007", "name": "Accessories", "description": "Scarves, belts, sunglasses, hats, and jewelry"},
]
